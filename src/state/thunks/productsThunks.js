...
import { setProduct, setProducts, setLoading, setError } from "../slices/productsSlice"
...
export const fetchSingleProduct = (productId) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(`${import.meta.env.VITE_API_URL}/products/id/${productId}`);
